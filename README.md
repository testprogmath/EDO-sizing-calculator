...
- **Методы аутентификации**:
  ...
  - **EAP-TEAP** - туннельная аутентификация с сертификатами

### Дополнительные опции

- **RADIUS Accounting** - учет сетевой активности (+23% к нагрузке)
- **OCSP проверка** - валидация сертификатов для EAP-TLS (+14%) и EAP-TEAP (+39%)
...
const authMethodCoefficients = {
    ...
    'EAP-TEAP': 2.7       // +170% к нагрузке
};

const additionalLoad = {
    accounting: 1.23,     // +23%
    ocsp_eap_tls: 1.14,   // +14% для EAP-TLS
    ocsp_eap_teap: 1.39,  // +39% для EAP-TEAP
    spoofing: 1.27,       // +27%
...
- **OCSP проверка** доступна для методов EAP-TLS и EAP-TEAP
